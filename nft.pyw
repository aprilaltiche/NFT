...
def mkdir():
   ...
   if not os.path.isdir(f'{folder}'):
      os.mkdir(f'{folder}')
   if not os.path.isdir(f'./layers2'):
      os.mkdir(f'./layers2')
...
def create():
  try:  
    ...
    Mbox('Information', 'Images has been successfuly created!', 0)
...
# label3 = Label(canvas,bg="white", text= "Make Sure you put to put your png layers on layer2 "+'\n')
# label3.pack()
# Entry3 = Entry(canvas)
...
label2 = Label(canvas,bg="white", text= "Enter name of Attribute to add "+'\n')
label2.pack()
Entry2 = Entry(canvas)
